...
landmark_style = draw_utils.DrawingSpec((0,255,0), thickness=1, circle_radius=5)
connection_style = draw_utils.DrawingSpec((0,0,255), thickness=1, circle_radius=5)
    ...
    if result:
        ...
        if outputs.multi_face_landmarks:
            ...
            if frame_count > min_frame:
                playsound('C:\\Users\\madhu\\OneDrive\\Desktop\\driver drowsiness\\alert.wav')
                speech.say('ALERT !!!!!! Driver you are sleeping please wake up!!!')
                speech.runAndWait()
